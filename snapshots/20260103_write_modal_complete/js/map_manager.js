...
const MapManager = {
    ...
    async setDestinationByClick(coords) {
        ...
        document.getElementById('search-input')?.setAttribute('value', addressName);
    ...
    setSimpleDestination(coords) {
        ...
        this.setDestination(coords, addressName);
        document.getElementById('search-input')?.setAttribute('value', addressName);
        const overlayDestEl2 = document.getElementById('overlay-destination');
        if (overlayDestEl2) overlayDestEl2.textContent = addressName;
    },

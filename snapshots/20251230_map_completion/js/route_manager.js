    ...
    routeStyleFunction(feature, resolution) {
        ...
        if (isFuture) {
            ...
            styles.push(new ol.style.Style({
                stroke: new ol.style.Stroke({ color: '#999999', width: 8, lineCap: 'round', lineJoin: 'round' }),
                zIndex: 0
            }));
            styles.push(new ol.style.Style({
                stroke: new ol.style.Stroke({ color: '#BBBBBB', width: 5, lineCap: 'round', lineJoin: 'round' }),
                zIndex: 1
            }));
        } else {
            // 현재 경로: 주황색 (zIndex 높음 - 위쪽에 렌더링)
            styles.push(new ol.style.Style({
                stroke: new ol.style.Stroke({ color: '#FF6B00', width: 10, lineCap: 'round', lineJoin: 'round' }),
                zIndex: 10
            }));
            styles.push(new ol.style.Style({
                stroke: new ol.style.Stroke({ color: '#FFA500', width: 6, lineCap: 'round', lineJoin: 'round' }),
                zIndex: 11
            }));
        }
